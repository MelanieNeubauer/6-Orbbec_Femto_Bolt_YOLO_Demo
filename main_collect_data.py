...
class RGBDCollectorApp:
        ...
        try:
            if self.is_capturing:
                ...
                if color_frame is not None and depth_frame is not None:
                    ...
                    cv2.line(preview, (left_line, 0), (left_line, self.windows_height), (0, 0, 255), 5)
                    cv2.line(preview, (right_line, 0), (right_line, self.windows_height), (0, 0, 255), 5)
    ...
    def capture_frame(self):
        ...
        w, h = int(320*self.size_scale), int(240*self.size_scale)
